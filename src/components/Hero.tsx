      ...
      <div className="container px-4 md:px-6 mx-auto max-w-7xl">
        <div className="flex flex-col items-center">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            <p className="sub-heading mb-4 opacity-0 animate-fade-in" style={{animationDelay: '0.1s'}}>
              The Limited Partner Intelligence Hub
            </p>
            <h1 className="heading-xl mb-6 opacity-0 animate-fade-in" style={{animationDelay: '0.3s'}}>
              Find your fund returners
            </h1>
            <p className="text-xl text-altss-slate mb-8 md:mb-10 opacity-0 animate-fade-in" style={{animationDelay: '0.5s'}}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center opacity-0 animate-fade-in" style={{animationDelay: '0.7s'}}>
              <Button asChild size="lg" className="bg-altss-deep-blue hover:bg-altss-blue transition-all duration-300 w-full sm:w-auto">
          ...
          <div className="w-full relative overflow-hidden rounded-lg border border-gray-200 shadow-lg mt-8 opacity-0 animate-fade-in" style={{animationDelay: '0.9s'}}>
          ...
          <div className="mt-16 md:mt-24">
            <p className="text-sm text-altss-slate text-center mb-8">Trusted by leading fund managers</p>
