...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
      {/* Background and overlay for better text readability */}
      <div className="absolute inset-0 bg-altss-deep-blue/80 -z-20"></div>
      <AnimatedBackground />
      
      <BlurredShape color="blue" size="xl" className="-top-20 -right-20 opacity-20" />
      <BlurredShape color="orange" size="lg" className="-left-20 top-40 opacity-10" />
      
      <div className="container px-4 md:px-6 mx-auto max-w-7xl">
        <div className="flex flex-col items-center">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            <p className="sub-heading mb-4 opacity-0 animate-fade-in text-white font-semibold" style={{animationDelay: '0.1s'}}>
              The Limited Partner Intelligence Hub
            </p>
            <h1 className="heading-xl mb-6 opacity-0 animate-fade-in text-white font-bold text-shadow-lg" style={{animationDelay: '0.3s'}}>
              Find your fund returners
            </h1>
            <p className="text-xl text-white mb-8 md:mb-10 opacity-0 animate-fade-in font-medium" style={{animationDelay: '0.5s'}}>
          ...
          <div className="mt-16 md:mt-24">
            <p className="text-sm text-white font-medium text-center mb-8">Trusted by leading fund managers</p>
