  ...
  return (
    <div className="flex w-full gap-[40px_100px] justify-between flex-wrap max-md:max-w-full">
      <div className="flex min-w-60 flex-col items-stretch px-4 max-md:max-w-full">
        <h2 className="min-h-11 text-xl text-[rgba(17,25,40,1)] font-bold">
          Account Information
        </h2>
      ...
      <div className="relative w-[282px] h-[282px] min-w-60">
        <input
          type="file"
          ref={fileInputRef}
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            <span
              className={`bg-white bg-opacity-70 px-3 py-2 rounded-md text-gray-800 font-medium transition-opacity ${
