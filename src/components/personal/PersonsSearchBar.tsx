...
const PersonsSearchBar = ({
  ...
  const handleAddToFavorites = async () => {
    ...
    try {
      ...
      await Promise.all(
        selectedPersonsDetails.map(async (person) => {
  ...
  return (
    <div className="flex min-h-11 gap-4 text-base text-[rgba(99,115,129,1)] font-medium flex-wrap mt-10 w-full">
      <div className="min-w-60 min-h-11 text-gray-400 font-normal w-[363px]">
        <div className="w-full flex-1">
          <div className="max-h-[44px] justify-between items-center border border-[#DFE4EA] bg-white flex w-full gap-2 flex-1 h-full pl-5 pr-4 py-3 rounded-[50px]">
            ...
            <button
              onClick={
                searchQuery ? handleClearSearch : () => onSearch?.(searchQuery)
              }
      ...
      <button
        className={`max-h-[44px] justify-center items-center border ${hasActiveFilters ? "bg-primary text-white border-primary hover:bg-primary/90" : "border-[#DFE4EA] bg-white hover:bg-gray-50"} flex gap-2 whitespace-nowrap px-4 py-2.5 rounded-[50px] transition-colors`}
      ...
      <button
        className="max-h-[44px] justify-center items-center border border-[#DFE4EA] bg-white hover:bg-gray-50 flex gap-2 px-4 py-2.5 rounded-[50px] transition-colors"
      ...
      <button
        className={`max-h-[44px] justify-center items-center border ${selectedPersons.length > 0 ? "bg-primary text-white border-primary hover:bg-primary/90" : "border-[#DFE4EA] bg-white hover:bg-gray-50"} flex gap-2 px-4 py-2.5 rounded-[50px] transition-colors`}
