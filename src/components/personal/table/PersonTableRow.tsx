    ...
    >
      ...
      {columns.find((col) => col.id === "name") && (
        <div
          ...
          style={{
            width: columns.find((col) => col.id === "name")!.width,
            minWidth: columns.find((col) => col.id === "name")!.minWidth,
          }}
      ...
      {columns.find((col) => col.id === "company") && (
        <div
          ...
          style={{
            width: columns.find((col) => col.id === "company")!.width,
            minWidth: columns.find((col) => col.id === "company")!.minWidth,
          }}
        >
      ...
      {columns.find((col) => col.id === "bio") && (
        <div
          className="border-r border-[rgba(223,228,234,1)] px-4 py-3 flex items-center"
          style={{
            width: columns.find((col) => col.id === "bio")!.width,
            minWidth: columns.find((col) => col.id === "bio")!.minWidth,
          }}
        >
      ...
      {columns.find((col) => col.id === "position") && (
        <div
          ...
          style={{
            width: columns.find((col) => col.id === "position")!.width,
            minWidth: columns.find((col) => col.id === "position")!.minWidth,
          }}
        >
      ...
      {columns.find((col) => col.id === "responsibilities") && (
        <div
          className="border-r border-[rgba(223,228,234,1)] px-4 py-3 flex items-center"
          style={{
            width: columns.find((col) => col.id === "responsibilities")!.width,
            minWidth: columns.find((col) => col.id === "responsibilities")!
              .minWidth,
          }}
        >
      ...
      {columns.find((col) => col.id === "contacts") && (
        <div
          ...
          style={{
            width: columns.find((col) => col.id === "contacts")!.width,
            minWidth: columns.find((col) => col.id === "contacts")!.minWidth,
          }}
        >
          {person.email && (
            <a
          ...
          {person.linkedin && (
            <a
              href={ensureProtocol(person.linkedin)}
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
      ...
      {columns.find((col) => col.id === "location") && (
        <div
          ...
          style={{
            width: columns.find((col) => col.id === "location")!.width,
            minWidth: columns.find((col) => col.id === "location")!.minWidth,
          }}
        >
          {person.location ? (
            <div className="flex items-center gap-1 px-2">
              <div className="bg-[rgba(0,126,96,0.1)] rounded-[4px] py-1 px-2">
                <span className="whitespace-nowrap text-[#006C50]">
                  {person.location}
                </span>
              </div>
            </div>
