...
const InvestorsSearchBar: React.FC<InvestorsSearchBarProps> = ({
  ...
  return (
    <>
      <div className="max-h-[44px] flex min-h-11 gap-4 text-base text-[rgba(99,115,129,1)] font-medium flex-wrap mt-10 w-full">
        ...
        <button
          className={`max-h-[44px] justify-center items-center border ${hasActiveFilters ? "bg-primary text-white border-primary hover:bg-primary/90" : "border-[#DFE4EA] bg-white hover:bg-gray-50 text-[#637381]"} flex gap-2 whitespace-nowrap px-4 py-2.5 rounded-[50px] transition-colors`}
