    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#features" className="text-altss-slate hover:text-altss-deep-blue transition-colors duration-200">Features</a>
          <a href="#testimonials" className="text-altss-slate hover:text-altss-deep-blue transition-colors duration-200">Testimonials</a>
          <a href="#pricing" className="text-altss-slate hover:text-altss-deep-blue transition-colors duration-200">Pricing</a>
