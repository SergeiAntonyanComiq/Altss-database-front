      ...
      <div className="flex-1 p-6 overflow-auto">
        <div className="rounded-lg border bg-card shadow-sm p-6">
          ...
          <div className="rounded-md border">
            <div className="grid grid-cols-6 bg-muted/50 text-sm font-medium text-muted-foreground">
              <div className="p-3 border-r flex items-center">Full Name</div>
              <div className="p-3 border-r flex items-center">Area of responsibility</div>
              <div className="p-3 border-r flex items-center">LinkedIn</div>
              <div className="p-3 border-r flex items-center">Resident Location</div>
              <div className="p-3 border-r flex items-center">Current Companies</div>
              <div className="p-3 flex items-center"></div>
            </div>
            
            <div>
              {displayedPersons.map((person) => (
                <div key={person.id} className="grid grid-cols-6 border-t hover:bg-muted/50">
                  ...
                  <div className="p-3 border-r">{person.linkedin}</div>
                  <div className="p-3 border-r">{person.location}</div>
                  <div className="p-3 border-r">
